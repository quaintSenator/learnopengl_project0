...
void process_spinning_cube_Zbuffer(GLFWwindow* window)
{
    //glDisable(GL_DEPTH_TEST);
	glEnable(GL_DEPTH_TEST);
	glDepthFunc(GL_LESS);
	
    const char* vsPath = "E:/workplace/vsworkplace/learnopengl_project0/learnopengl_project0/draw_cube_Zbuffer_vs.glsl";
    const char* fsPath = "E:/workplace/vsworkplace/learnopengl_project0/learnopengl_project0/draw_cube_Zbuffer_fs.glsl";
